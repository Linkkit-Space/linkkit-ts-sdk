 ...
 */
export function webhooksSubscribe(
  client: LinkkitCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PostV1HooksRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/hooks")();
