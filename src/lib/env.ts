...
export interface Env {
  LINKKIT_BEARER_AUTH?: string | undefined;
  LINKKIT_API_KEY_AUTH?: string | undefined;

  LINKKIT_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  LINKKIT_BEARER_AUTH: z.optional(z.string()),
  LINKKIT_API_KEY_AUTH: z.optional(z.string()),

  LINKKIT_DEBUG: z.optional(z.coerce.boolean()),
});
